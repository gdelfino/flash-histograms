...
Sprout::ProjectModel.setup do |model|
  model.project_name  = 'Irreversible'
  # Default Values:
  # model.src_dir       = 'src'
  # model.lib_dir       = 'lib'
  # model.swc_dir       = 'lib'
  ...
  model.language      = 'as3'
  model.output        = "#{model.bin_dir}/Irreversible.swf"
  model.test_output   = "#{model.bin_dir}/IrreversibleRunner.swf"
end
...
#  t.gem_name                  = 'sprout-flex3sdk-tool'
  ...
  t.default_frame_rate        = 60
  t.default_size              = '907 590'
  t.input                     = "#{model.src_dir}/Irreversible.as"
  t.source_path               << model.asset_dir
#  t.source_path               << "/Applications/Adobe Flash CS3/Configuration/Component Source/ActionScript 3.0/User Interface/"
#  t.source_path               << "/Users/gdelfino/Documents/flash/cs3/"
...
#  t.gem_name                  = 'sprout-flex3sdk-tool'
  ...
  t.input                     = "#{model.src_dir}/IrreversibleRunner.as"
